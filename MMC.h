...
#define MMC_VOLTAGE_CHECK          0x48     //CMD8
...
//MMC/SD Card initialization should follow standard
//from sdcard.org.
//In the document "Simplified SD Host Controller Spec"
//see section 3.6 beginning on page 86
char mmcInit(void);
